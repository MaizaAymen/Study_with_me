...
describe('Chatbot Test', () => {
  ...
  it('should display the chat interface when logged in', () => {    // Check if the chat interface is visible
  ...
  it('should show chat history when clicking history tab', () => {
    ...
    cy.contains('What is quantum physics?').should('exist')
    cy.contains('How do I prepare for a math exam?').should('exist')
  })
